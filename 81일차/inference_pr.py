...
# Config 설정(Train과 동일하게)
# 1. Dyanmic RCNN setting...
...
class WineLabelsDataset(CocoDataset):
    CLASSES = ('wine-labels', 'AlcoholPercentage', 'Appellation AOC DOC AVARegion', 'Appellation QualityLevel',
               'CountryCountry', 'Distinct Logo', 'Established YearYear', 'Maker-Name', 'Organic', 'Sustainable',
...
# train val test dataset -> type data_root ann_file img_prefix hyp settings...
