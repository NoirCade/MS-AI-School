...
albumentations_transform = albumentations.Compose([
    ...
    # OneOf 리스트 내에서 랜덤으로 실행되게 지정할 수 있다!
    # -> 조건부 확률로 OneOf가 실행되면 그 안에서 또 확률 실행
...
alb_dataset = alb_cat_dataset(
    file_paths=['./cat.png'], transform=albumentations_transform)

cat_dataset = CatDataset(
    file_paths=["./cat.png"], transform=torchvision_transform)
