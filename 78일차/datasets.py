...
from config import CLASSES, RESIZE_TO, TRAIN_DIR, VALID_DIR, BATCH_SIZE,\
    CARD_CLASSES, CARD_NUM_CLASSES, CARD_TRAIN_DIR, CARD_VALID_DIR
...
class MicrocontrollerDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_name = self.all_imagese[idx]
...
# prepare final datasets and data loader
train_dataset = MicrocontrollerDataset(TRAIN_DIR, RESIZE_TO, RESIZE_TO,
                                        CLASSES, get_train_transform())

valid_dataset = MicrocontrollerDataset(VALID_DIR, RESIZE_TO, RESIZE_TO,
...
if __name__ == '__main__':
    dataset = MicrocontrollerDataset(CARD_TRAIN_DIR, RESIZE_TO, RESIZE_TO,
                                     CARD_CLASSES)
