...
def rename_legal():
    ...
    legal_paths = [r'D:/CCTV/01.data/1.Train/image/object/legal',
                   r'D:/CCTV/01.data/1.Train/label/object/legal',
                   r'D:/CCTV/01.data/2.Valid/image/object/legal',
                   r'D:/CCTV/01.data/2.Valid/label/object/legal']
...
def rename_illegal():
    folder_name = {'10.좌판': 'sit_board', '11.노점상': 'street_vendor', '12.푸드트럭': 'food_truck', '13.현수막': 'banner',
                   '14.텐트': 'tent', '15.연기': 'smoke', '16.불꽃': 'flame', '17.반려동물': 'pet',
                   '9.쓰레기봉투': 'garbage_bag'}

    illegal_paths = [r'D:/CCTV/01.data/1.Train/image/object/illegal',
                     r'D:/CCTV/01.data/1.Train/label/object/illegal',
                     r'D:/CCTV/01.data/2.Valid/image/object/illegal',
                     r'D:/CCTV/01.data/2.Valid/label/object/illegal']

    for illegal_path in illegal_paths:
        # print(os.listdir(illegal_path))
